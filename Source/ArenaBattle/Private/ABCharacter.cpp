...
AABCharacter::AABCharacter()
{
	...
	SpringArm = CreateDefaultSubobject<USpringArmComponent>(TEXT("SPRINMGARM"));
	...
	static ConstructorHelpers::FClassFinder<UUserWidget>
		UI_HUD(TEXT("WidgetBlueprint'/Game/Book/UI/UI_HPBar.UI_HPBar_C'"));
	if (UI_HUD.Succeeded())
	{
...
void AABCharacter::AttackCheck()
{
	...
	FVector Center = GetActorForwardVector() + TraceVec * 0.5f;
