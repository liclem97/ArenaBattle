...
AABPlayerController::AABPlayerController()
{
	static ConstructorHelpers::FClassFinder<UABHUDWidget>
		UI_HUD_C(TEXT("WidgetBlueprint'/Game/Book/UI/UI_HUD.UI_HUD_C'"));
	...
	static ConstructorHelpers::FClassFinder<UABGameplayWidget>
		UI_MENU_C(TEXT("WidgetBlueprint'/Game/Book/UI/UI_Menu.UI_Menu_C'"));
	...
	static ConstructorHelpers::FClassFinder<UABGameplayResultWidget>
		UI_RESULT_C(TEXT("WidgetBlueprint'/Game/Book/UI/UI_Result.UI_Result_C'"));
